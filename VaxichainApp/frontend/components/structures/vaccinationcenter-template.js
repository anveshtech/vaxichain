...
import DataTable from "../blocks/data-table-vaccinationcenters"
import { useRouter } from "next/navigation"
import { useState, useEffect } from "react"
import VaccinationCenterProvider from "@/contexts/vaccinationcenters-context"
import Button from "../elements/button"
import { getCurrentUser } from "@/contexts/query-provider/api-request-functions/api-requests"

export default function VaccinationCenterTemplate() {
  const title = "Vaccination Centers List"
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {userRole !== "dataCollectorUser" && userRole !== "super-admin" && (
          <div className="flex gap-4">
            <>
              <Button
                onClick={() => router.push("/vaccinationcenters/add-vaccinationcenters")}
